...
namespace FFXI_IconChange
{
	...
	{
        //Entire Icon Object
        public static int SIZE_ICON = 0x1800;
        ...
        public static int SIZE_IMAGE = 0x1580;
        ...
        private static int OFFSET_DESCR = 0x2C;
        private static int SIZE_DESCR = 0x100;
        ...
        private static int SIZE_IMAGE_DATA = 0x1000;
        private static int SIZE_IMAGE_DATA_SMALL = 0x400;
        //Hopefully the total of the field sizes = SIZE_ICON (0x1800)
		...
		public Bitmap Bitmap
		{
			get
			{
                ...
                mIcon = new Bitmap(32, 32, System.Drawing.Imaging.PixelFormat.Format32bppRgb);
        ...
        public Bitmap SmallBitmap
        {
            get
            {
                ...
                System.Runtime.InteropServices.Marshal.Copy(mBytes, OFFSET_IMAGE_DATA, ptr, SIZE_IMAGE_DATA_SMALL);
        ...
        private bool BitmapEqual(Bitmap b1, Bitmap b2)
        {
        ...
        public bool BitmapEquals(Bitmap bmp)
        {
            return BitmapEqual(this.Bitmap, bmp);
        }

        public bool SmallBitmapEquals(Bitmap bmp)
        {
            return BitmapEqual(this.SmallBitmap, bmp);
        }
	}
}
